...
public class AutomaticFeedforwardTuner extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        ppb.setPoseEstimate(new Pose2d());
        ...
        while (!isStopRequested()) {
            ...
            positionSamples.add(ppb.getPoseEstimate().getX());
            powerSamples.add(power);

            ppb.setDrivePower(new Pose2d(power, 0.0, 0.0));
                ppb.updatePoseEstimate();
        }
        ppb.setDrivePower(new Pose2d(0.0, 0.0, 0.0));
        ...
        if (fitAccelFF) {
            ...
            ppb.setPoseEstimate(new Pose2d());
            ppb.setDrivePower(new Pose2d(MAX_POWER, 0.0, 0.0));
